    ...
    >
      ...
      <div className="p-6">
        ...
        <div className="flex gap-3">
          {game.itchUrl && (
            <a href={game.itchUrl} target="_blank" rel="noopener noreferrer" className={`inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-sm font-medium transition-all duration-300 bg-accent/10 text-accent border border-accent/20 hover:bg-accent/20 hover:shadow-[0_0_20px_rgba(250,204,21,0.1)] ${game.sourceUrl ? 'flex-1' : 'w-full'}`}>
              <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z"/><path strokeLinecap="round" strokeLinejoin="round" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
              Play on Itch.io
            </a>
          )}
          {game.sourceUrl && (
            <a href={game.sourceUrl} target="_blank" rel="noopener noreferrer" className={`inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-sm font-medium transition-all duration-300 bg-white/5 text-body border border-white/5 hover:bg-white/10 hover:text-white ${game.itchUrl ? 'flex-1' : 'w-full'}`}>
